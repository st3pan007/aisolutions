...
function showContactInfo() {
    ...
    overlay.innerHTML = '<div style="background: linear-gradient(135deg, rgba(0, 245, 255, 0.1), rgba(0, 102, 204, 0.1)); border: 2px solid var(--primary); border-radius: 25px; padding: 3rem; text-align: center; backdrop-filter: blur(20px); max-width: 500px;"><h2 style="color: var(--primary); margin-bottom: 2rem;">Kontaktní informace</h2><div style="font-size: 1.2rem; line-height: 2;"><p><i class="fas fa-user"></i> <strong>Pavel Novotný</strong></p><p><i class="fas fa-envelope"></i> info@aisolutions.com</p><p><i class="fas fa-phone"></i> +420 111 222 333</p><p><i class="fas fa-building"></i> AI Solutions s.r.o.</p></div><button onclick="this.parentElement.parentElement.remove()" style="margin-top: 2rem; padding: 1rem 2rem; background: var(--gradient); border: none; border-radius: 25px; color: white; font-weight: bold; cursor: pointer;">Zavřít</button></div>';
